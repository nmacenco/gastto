---
name: commit
description: Create clear, comprehensive commits and Pull Requests that align with project standards and make review and traceability straightforward. Use this skill when the user asks to commit changes, create PRs, or manage version control workflows. Generates well-structured commit messages and PR descriptions that follow best practices.
argument-hint: Optional. Provide feature/ticket identifiers to scope the commit (e.g. "SCRUM-123", "feature-x"). If you want only the commit message without git operations, say "no PR", "only commit", "just the message", or "dry run".
...
- Make it **descriptive** following Git best practices.
...
- Descriptive commits with feature branches and focused changes
