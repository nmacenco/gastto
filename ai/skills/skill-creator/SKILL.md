...
All skills must be written in **English** — the `name`, `description` frontmatter, headings, body text, examples, and inline comments. This is required so skills are consistently discoverable and readable regardless of who is working on the project.
