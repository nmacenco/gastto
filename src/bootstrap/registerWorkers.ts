...
export async function registerWorkers(
  ...
  const messageWorker = createMessageWorker({
    ...
    dispatchControlSemanticAction: deps.dispatchControlSemanticAction,
    dispatchOptionSelection: deps.dispatchOptionSelection ?? null,
    ...
    presentUndoConfirmation: deps.presentUndoConfirmation,
