...
export const FSM_TRANSITIONS: Record<FsmState, FsmState[]> = {
  ...
  ONBOARDING_FILE: ['ONBOARDING_FILE', 'ONBOARDING_SHEET'],
  ONBOARDING_SHEET: ['ONBOARDING_SHEET', 'ONBOARDING_VALIDATING_ACCESS'],
  ONBOARDING_VALIDATING_ACCESS: ['ONBOARDING_MAPPING', 'ONBOARDING_SHEET', 'ONBOARDING_START'],
  ONBOARDING_MAPPING: ['ONBOARDING_MAPPING', 'ONBOARDING_CATEGORIES'],
