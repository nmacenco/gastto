...
- [x] `semantic-router-control-flows.integration.spec.ts` - PostgreSQL/Redis scenarios for revision-bound cancellation/FIFO and confirmation-only inferred undo are defined; they run when Docker is available.
