...
- [`subcategory-hierarchy.md`](./subcategory-hierarchy.md) — Detects, presents, modifies, and atomically confirms parent-scoped subcategories while excluding and reporting orphans.
