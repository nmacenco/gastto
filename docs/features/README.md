...
- [`category-confirmation.md`](./category-confirmation.md) — Reads the active flat category vocabulary and provides an unwired provider-independent hierarchy reader that preserves linked category/subcategory rows without changing onboarding behavior.
